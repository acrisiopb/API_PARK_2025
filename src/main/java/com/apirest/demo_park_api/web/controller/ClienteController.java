...
public class ClienteController {
    ...
    @Operation(summary = "Localizar um cliente.", description = "Recurso para localizar um cliente pelo ID."
            ...
            "Requisição exige uso de um bearer token. Acesso restrito a Role = 'ADMIN' ", security = @SecurityRequirement(name = "security"), responses = {
                    ...
                    @ApiResponse(responseCode = "403", description = "Recursos não permitido ao perfil CLIENTE.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class)))
    ...
    @Operation(summary = "Recuperar dados do cliente autenticado.", description = "Requição exige uso de um bearer token. Acesso restrito a Role = 'CLIENTE' ", security = @SecurityRequirement(name = "security"), responses = {
